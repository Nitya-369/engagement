...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cinzel+Decorative:wght@400;700;900&family=Great+Vibes&family=Noto+Sans+Gujarati:wght@400;600;700&family=Playfair+Display:wght@500;700;900&family=Poppins:wght@300;400;500;600&family=Tangerine:wght@400;700&family=Tiro+Devanagari+Sanskrit:ital@0;1&family=Amita:wght@400;700&display=swap",
      },
    ],
  }),
